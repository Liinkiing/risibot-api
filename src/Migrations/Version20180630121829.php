...
final class Version20180630121829 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE risipic (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, url VARCHAR(255) NOT NULL, tags LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', extension VARCHAR(6) NOT NULL, INDEX IDX_549EA2412469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
